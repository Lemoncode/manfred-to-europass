...
describe("mapper.tests", () => {
  ...
  `, () => {
    // Arrange
    const dataCvManfred: baseModel.ManfredAwesomicCV = undefined

    // Act
    const result: finalModel.SkillsPassport = mapFromModelToEuropass(dataCvManfred);
  ...
  `, () => {
    // Arrange
    const dataCvManfred: baseModel.ManfredAwesomicCV = null
